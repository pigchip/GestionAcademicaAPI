        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailPersonal = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PropuestaMaterias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PropuestaMaterias_Materias_IdMateria",
                        column: x => x.IdMateria,
                        principalTable: "Materias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PropuestaMaterias_Propuestas_IdPropuesta",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropuestaMaterias_IdMateria",
                table: "PropuestaMaterias",
                column: "IdMateria");

            migrationBuilder.CreateIndex(
                name: "IX_PropuestaMaterias_IdPropuesta",
                table: "PropuestaMaterias",
                column: "IdPropuesta");
